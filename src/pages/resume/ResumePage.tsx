...
//             <div className="flex flex-col gap-2 px-6 py-5 border-b border-slate-200 bg-slate-50">
...
//                     target="_blank"
//                     rel="noreferrer"
//                     className="rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-50 transition"
//                   >
//                     Open in new tab
//                   </a>
//                   <button
...
//             <div className="px-4 sm:px-6 py-6 bg-[#e4e4e4]">
//               <PdfToImages source={{ type: "url", url: pdfUrl }} scale={2} />
//             </div>
//           </div>
//         </div> */}
//         <div className="px-60 py-10 bg-[#f1f0ee]">
//           <PdfToImages source={{ type: "url", url: pdfUrl }} scale={2} />

//           <button
//             type="button"
//             onClick={handleDownload}
//             className="cursor-pointer bg-primary mt-6 text-white border border-primary rounded-sm w-full py-1.5 text-center"
//           >
//             Download Resume
//           </button>
//         </div>
...
//       {/* AWARDS */}
//       <div id="awards" className="w-full px-4 sm:px-8 pt-14 pb-16">
